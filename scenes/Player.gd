...
var jumpSpeed = 330
var jumpTermminationMultiplier = 3
...
func _ready():
	$HazardArea.connect("area_entered", self, "on_hazaed_area_entered")
...
func process_normal(delta):
	...
	if(velocity.y < 0 && !Input.is_action_pressed("jump")):
		velocity.y += gravity * jumpTermminationMultiplier * delta
	else:
...
func process_input_disable(delta):
	if(isStateNew):
...
func on_hazaed_area_entered(area2d):
